...
.EXAMPLE
   PS C:\> .\Evergreen-Win-Install-Adobe-ReaderDC.ps1
...
$LogPS = "${env:SystemRoot}" + "\Temp\Adobe Acrobat Reader DC $Version PS Wrapper.log"
...
New-Item -ItemType "file" -Path "c:\logfiles\AdobeReaderDC-LSR.txt"
