...
Invoke-WebRequest https://www.kinovea.org/setup/kinovea.0.9.5/Kinovea-0.9.5-x64.exe -OutFile C:\temp\Kinovea-0.9.5-x64.exe

# Install Application Name
Write-Verbose "Starting Installation of Application Name" -Verbose
$params = @{
             FilePath     = "C:\temp\Kinovea-0.9.5-x64.exe"
             ArgumentList = "/S"
             WindowStyle  = "Hidden"
             PassThru     = $True
             Verbose      = $True
