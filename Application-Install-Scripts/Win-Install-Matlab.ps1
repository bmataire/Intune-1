...
Remove-Item "C:\ProgramData\Microsoft\Windows\Start Menu\Programs\MATLAB R2021a\Activate MATLAB R2021a.lnk"
Remove-Item "C:\ProgramData\Microsoft\Windows\Start Menu\Programs\MATLAB R2021a\Deactivate MATLAB R2021a.lnk"
