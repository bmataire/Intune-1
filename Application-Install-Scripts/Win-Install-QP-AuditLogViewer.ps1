...
Start-Process -FilePath "$env:systemroot\system32\msiexec.exe" -ArgumentList '/i "Q-Pulse Audit Log Viewer.msi" /qn ALLUSERS=NULL installdir="C:\Program Files (x86)\Gael Ltd\Q-Pulse Audit Log Viewer 7"'

## Pause for 2 minutes to allow install to completed.
Start-Sleep -Seconds 120

## Create Config File in "C:\Program Files (x86)\Gael Ltd\Q-Pulse Audit Log Viewer 7\"
...
$ConfigurationFile = 'C:\Program Files (x86)\Gael Ltd\Q-Pulse Audit Log Viewer 7\AuditLogViewer.exe.config'
