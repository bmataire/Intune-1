<# 
.SYNOPSIS
   Install Script for Anaconda Individual Edition

.DESCRIPTION
   Installs Anaconda Individual Edition.

.EXAMPLE
   PS C:\> .\Win-Install-Anaconda.ps1
...
$Path = $env:TEMP;
$Vendor = "Anaconda Inc."
$Product = "Anaconda Individual Edition"
$PackageName = "Anaconda"
$Version = "3-2021.11-Windows-x86_64"
$InstallerType = "exe"
$Source = "$PackageName" + "." + "$InstallerType"
$URL = "https://repo.anaconda.com/archive/Anaconda3-2021.11-Windows-x86_64.exe"
$LogPS = "${env:SystemRoot}" + "\Temp\$Vendor $Product $Version PS Wrapper.log"
$UnattendedArgs = '/InstallationType=AllUsers /RegisterPython=1 /S'
