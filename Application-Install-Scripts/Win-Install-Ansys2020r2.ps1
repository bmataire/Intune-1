<# 
.SYNOPSIS
   Install Script for Ansys 2020r2
...
.EXAMPLE
   PS C:\> .\Win-Install-Ansys2020r2.ps1
...
## install Ansys 2020r2
&C:\temp\ansys\setup.exe -silent -licserverinfo 2325:1055:ansys-lic.eps.surrey.ac.uk -media_dir2 c:\temp\ansys\ANSYS2020R2_WINX64_Disk2 -media_dir3 c:\temp\ansys\ANSYS2020R2_WINX64_Disk3 | Out-Null
...
New-Item -ItemType "file" -Path "c:\logfiles\ansys2020r2.txt"
