<# 
.SYNOPSIS
   Install Global Protect(64) Version 5.2.10

.DESCRIPTION
   Script to remove currently installed version of Global Protect and install Global Protect(64) Version 5.2.10.
...
$install = "C:\temp\GlobalProtect64-5.2.10.msi"
    if ($uninstall64) {
...
New-Item -ItemType "file" -Path "c:\logfiles\GlobalProtect64-5.2.10.txt"