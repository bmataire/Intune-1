...
.DESCRIPTION
   Download and install Zotero version 5.0.96.3.

.EXAMPLE
   PS C:\> .\Win-Install-Zotero.ps1
...
$URL = "https://download.zotero.org/client/release/5.0.96.3/Zotero-5.0.96.3_setup.exe"
