<# 
.SYNOPSIS
   Install Script for Microsoft .NET Framework 4.5.

.DESCRIPTION
   Installs Microsoft .NET Framework 4.5.

.EXAMPLE
   PS C:\> .\Windows-Install-dotnet4.5-Framework.ps1
...
$Path = $env:TEMP;
$Vendor = "Microsoft"
$Product = "Microsoft .NET Framework 4.5"
