...
Try {
	...
	If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
		...
		Show-InstallationWelcome -CloseApps 'FileZilla' -CheckDiskSpace -PersistPrompt -CloseAppsCountdown 600
		...
		[string]$MyArguments = "-ExecutionPolicy Bypass -NoLogo -File `"$dirFiles\Install-Filezilla.ps1`" "
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		## Show Welcome Message, close 7-Zip with a 600 second countdown before automatically closing
		Show-InstallationWelcome -CloseApps 'FileZilla' -CloseAppsCountdown 600
		...
		Remove-MSIApplications -Name 'FileZilla'
