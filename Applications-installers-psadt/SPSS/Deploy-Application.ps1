...
Try {
	...
	If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
		...
		Show-InstallationWelcome -CloseApps 'stats,spss,amos' -CheckDiskSpace -PersistPrompt
		...
		##SPSS Stats 23 GUID {C3BA73A4-2A45-4036-8541-4F5F8146078B}
		##SPSS Stats 24 GUID {4762AE15-E5A3-43BF-8822-1CFC70FB147A}
		##SPSS Stats 25 GUID {C2D1E17D-CB8A-4742-84FA-1DB5C6A1ABDD}
		##SPSS Stats 26 GUID {1AC22BAE-DC13-4991-9910-AE3743A4592D}
		##SPSS Stats 27 GUID {8EAD21F8-AD8B-4C6F-ABE6-92357CAB043E}
		##SPSS Stats 27.0.1 GUID {4FEFE042-19D2-47AD-9D27-B24710418A05}
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Show-InstallationWelcome -CloseApps 'stats,spss,amos' -CloseAppsCountdown 60
		...
		$exitCode = Execute-MSI -Action "Uninstall" -Path "{DC8AD675-36E2-44AD-8FB9-FA069BEAC142}" -AddParameters "ALLUSERS=1 REMOVE=`"ALL`"" -PassThru
