...
Try {
	...
	[string]$appName = 'Citrix Workspace App'
	[string]$appVersion = 'Latest'
	[string]$appArch = 'x86'
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '1.0.0'
	[string]$appScriptDate = '30/05/2022'
	[string]$appScriptAuthor = 'Alex Durrant'
	##*===============================================
	## Variables: Install Titles (Only set here to override defaults set by the toolkit)
	[string]$installName = ''
	[string]$installTitle = 'Citrix Workspace App'
	...
	If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
		...
		Show-InstallationWelcome -CloseApps 'AuthManSvr,concentr,Receiver,redirector,SelfService,SelfServicePlugin,wfcrun32' -CheckDiskSpace -PersistPrompt -CloseAppsCountdown 600

		## Show Progress Message (with the default message)
		## Show-InstallationProgress

		## <Perform Pre-Installation tasks here>
        ## Remove Any Existing Versions of Citrix Workspace
		...
		[string]$MyArguments = "-ExecutionPolicy Bypass -NoLogo -File `"$dirFiles\InstallCitrixWorkspace.ps1`" "
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
        ...
        ## Uninstall Any Existing Versions of Citrix Workspace
        $AppList = Get-InstalledApplication -Name 'Citrix Workspace'
